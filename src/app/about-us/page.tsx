    ...
    <section className="bg-black">
      ...
      <div className="bg-white p-10">
        ...
        <p className="text-center justify-center regular-18 max-w-4xl mr-auto ml-auto mb-6">
          Це провідний заклад загальної середньої освіти в селі Нижні Ворота Мукачівського
          району Закарпатської області. Нижньоворітський ліцей має свою цікаву і
          самобутню історію. Зокрема, загальну середню освіту він розпочав
          надавати з 1950 року і працює до тепер.
        </p>
        <div className="mb-5">
          <SchoolInfoCard />
        </div>
