...
export const metadata: Metadata = {
  ...
  description:
    "Нижньоворітський заклад загальної середньої освіти - школа з широким спектром методик, що успішно навчає дітей та підтримує розвиток громадянської позиції української молоді.",
  keywords: ["Нижньоворітський ЗЗСО", "Нижні Ворота", "школа", "освіта"],
