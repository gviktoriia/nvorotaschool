...
export const metadata: Metadata = {
  ...
  description:
    "Заклад загальної середньої освіти в с. Нижні Ворота. Нижньоворітський ЗЗСО - школа з широким спектром методик, що успішно навчає дітей та підтримує розвиток громадянської позиції української молоді.",
